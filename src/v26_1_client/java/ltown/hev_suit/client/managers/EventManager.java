...
public class EventManager {
    ...
    private static final KeyMapping.Category CONFIG_CATEGORY;
    ...
    private static void handleDamage(Minecraft client, float damage, DamageSource damageSource) {
        ...
        if (damageSource.is(DamageTypes.FALL) && SettingsManager.fracturesEnabled && currentTime - lastFractureTime >= FRACTURE_COOLDOWN) {
            if (damage >= 6) {
